...
которые бережно относятся к фотографиям. На его базе можно сделать маску, которая защитит
сложные зашумлённые фрагменты фотографий от еще больших искажений в результате применения других фильтров.
